				...
				<div class="team-details">
					...
					<ul class="dt-sc-social-icons">
						...
						<li style="margin-right: 5px; padding: 3px; border: 1px #DDDDDD solid;">
							<a href="<?php echo $socmed_item['account_url'];?>" title="<?php echo filter_var(trim($socmed_item['account_name']), FILTER_SANITIZE_STRING); ?>" target="_blank" rel="nofollow"><span class="fa <?php echo $socmedias_logo[$socmed_item['socmed_type']]; ?>"></span>
